...
export const metadata: Metadata = { title: "Top Creators — AutoClipr" };
...
export default function TopCreatorsPage() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-3xl font-bold text-white">Top Creators</h1>
      <p className="mt-3 max-w-md text-white/50">
        Discover the top creators using AutoClipr to grow their channels. Coming soon.
      </p>
      <Link
        href="/"
